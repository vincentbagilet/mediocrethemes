#' Defines the ggplot theme used for \code{ididvar} visualizations.
#'
#' @param pal a string. Defines the color palette selected.
#' Can either be either "autumn", "rainbow", "green",
#'  "hotcold", "blackandwhite", "coty", "leo", "portal", "pem" or "idid"
...
theme_idid <- function(
  ...
  if (!(base_family %in% sysfonts::font_families())) {
    new_font <- showtextdb::google_fonts(base_family)
    showtextdb::font_install(new_font)
  }
  showtext::showtext_auto()
