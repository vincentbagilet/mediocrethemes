...
theme_mediocre <- function() {
  ...
  ggplot2::theme_minimal(base_size = 11, base_family = "opensans") %+replace%
    ggplot2::theme(
      ...
      axis.title.x = ggplot2::element_text(margin = ggplot2::margin(t = .3, unit = "cm")),
      axis.title.y = ggplot2::element_text(margin = ggplot2::margin(r = .3, unit = "cm"), angle = 90),
      plot.title.position = "plot",
      plot.title = ggplot2::element_text(hjust = 0, size = ggplot2::rel(1.4), margin = ggplot2::margin(b = .7, unit = "cm")),
      plot.subtitle = ggplot2::element_text(hjust = 0, size = ggplot2::rel(1.2), face = "italic", margin = ggplot2::margin(t = -.5, b = .7, unit = "cm")),
      legend.position = "top",
