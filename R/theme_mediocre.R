...
theme_mediocre <- function() {
  ...
  ggplot2::theme_minimal() %+replace%
    ggplot2::theme(
      ...
      panel.grid.major.y = ggplot2::element_line(colour = color_type[["dark"]], size = rel(0.1)),
      ...
      plot.title = ggplot2::element_text(hjust = rel(0.1), size = rel(1.2)),
      plot.subtitle = ggplot2::element_text(hjust = rel(0.12), vjust = rel(0), size = rel(0.9), face = "italic"),
      legend.position = "top",
