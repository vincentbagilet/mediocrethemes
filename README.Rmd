...
One can also easly remove the background for their plots by setting the parameter `background` of the functions `theme_mediocre` or `set_mediocre_all` to `FALSE`:
