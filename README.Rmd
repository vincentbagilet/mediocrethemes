...
This package provides both `ggplot` themes and a breadth of color palettes. The package has been updated with a more modern theme (`idid`) but the initial theme (`mediocre`) is still available (and remains the default).
...
for (palette in mediocrethemes::colors_table[[1]][-1]) {
  set_mediocre_all(pal = palette, theme = "idid")
