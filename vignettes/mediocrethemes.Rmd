...
for (palette in mediocrethemes::colors_mediocre[[1]]) {
...
As a side effect, the function `set_mediocre_all` creates a one line tibble (`colors_mediocre`) with all the color information relative to the current palette:
