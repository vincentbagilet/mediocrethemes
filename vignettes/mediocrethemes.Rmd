...
set_mediocre_all(pal = "coty", theme = "idid")
...
plot_all_examples <- function(pal) {
  set_mediocre_all(pal = pal, theme = "idid")
  ...
  if (pal != "blackandwhite") {
    ...
    scale_mediocre_d(pal = pal, theme = "idid", gradient = "left") +
    labs(title = "A very nice title", subtitle = "A disappointing subtitle")
  ...
  plot7 <- ggplot(data = ggplot2::diamonds, aes(x = price, fill = color)) +
    geom_histogram(bins = 30) +
    scale_mediocre_d(pal = pal, theme = "idid", gradient = "right") +
    labs(title = "A very nice title", subtitle = "A disappointing subtitle") 
...
set_mediocre_all(pal = "idid", theme = "idid", gradient = "left")
...
set_mediocre_all(pal = "idid", theme = "idid", gradient = "right")
...
```{r background}
set_mediocre_all(pal = "idid", theme = "idid", background = TRUE)
...
```{r second_pair}
set_mediocre_all(pal = "idid", theme = "idid", second_pair = TRUE)
